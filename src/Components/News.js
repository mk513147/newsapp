...
const News = (props) => {
    ...
    useEffect(() => {
        document.title = `${capitalFirstLetter(props.category)} - News Fresh`;
        updateNews();
    ...
    return (
        <>
            ...
            <h1 className='text-center my-4' >Fresh News - Top {capitalFirstLetter(props.category)} Headlines</h1>
            {loading && <Spinner />}
            <InfiniteScroll
